          ...
          <div class="left-header col-xxl-5 col-xl-6 col-lg-5 col-md-4 col-sm-3 p-0">
            <div> <a class="toggle-sidebar" href="#"> <i class="iconly-Category icli"> </i></a>
              <div class="d-flex align-items-center gap-2 ">
                <h4 class="f-w-600">Welcome Alex</h4><img class="mt-0" src="admin/assets/images/hand.gif" alt="hand-gif">
              </div>
            </div>
            ...
            <div id="sidebar-menu">
              <ul class="sidebar-links" id="simple-bar">
                ...
                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav" href="kanban.html">
                    <svg class="stroke-icon">
                      <use href="admin/assets/svg/icon-sprite.svg#stroke-board"></use>
                    </svg>
                    <svg class="fill-icon">
                      <use href="admin/assets/svg/icon-sprite.svg#fill-board"></use>
                ...
                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav" href="task.html">
                    <svg class="stroke-icon">
                      <use href="admin/assets/svg/icon-sprite.svg#stroke-task"></use>
                    </svg>
                    <svg class="fill-icon">
                      <use href="admin/assets/svg/icon-sprite.svg#fill-task"> </use>
                ...
                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav" href="social-app.html">
                    <svg class="stroke-icon">
                      <use href="admin/assets/svg/icon-sprite.svg#stroke-social"></use>
                    </svg>
                    <svg class="fill-icon">
                      <use href="admin/assets/svg/icon-sprite.svg#fill-social"> </use>
                ...
                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav" href="to-do.html">
                    <svg class="stroke-icon">
                      <use href="admin/assets/svg/icon-sprite.svg#stroke-to-do"></use>
                    </svg>
                    <svg class="fill-icon">
                      <use href="admin/assets/svg/icon-sprite.svg#fill-to-do"> </use>
                ...
                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="#">
                    <svg class="stroke-icon">
                      <use href="admin/assets/svg/icon-sprite.svg#stroke-ui-kits"></use>
                    </svg>
                    <svg class="fill-icon">
                      <use href="admin/assets/svg/icon-sprite.svg#fill-ui-kits"></use>
                ...
                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="#">
                    <svg class="stroke-icon">
                      <use href="admin/assets/svg/icon-sprite.svg#stroke-bonus-kit"></use>
                    </svg>
                    <svg class="fill-icon">
                      <use href="admin/assets/svg/icon-sprite.svg#fill-bonus-kit"></use>
                ...
                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="#">
                    <svg class="stroke-icon">
                      <use href="admin/assets/svg/icon-sprite.svg#stroke-animation"></use>
                    </svg>
                    <svg class="fill-icon">
                      <use href="admin/assets/svg/icon-sprite.svg#fill-animation"></use>
                ...
                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="#">
                    <svg class="stroke-icon">
                      <use href="admin/assets/svg/icon-sprite.svg#stroke-icons"></use>
                    </svg>
                    <svg class="fill-icon">
                      <use href="admin/assets/svg/icon-sprite.svg#fill-icons"></use>
                ...
                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="#">
                    <svg class="stroke-icon">
                      <use href="admin/assets/svg/icon-sprite.svg#stroke-button"></use>
                    </svg>
                    <svg class="fill-icon">
                      <use href="admin/assets/svg/icon-sprite.svg#fill-botton"></use>
                ...
                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="#">
                    <svg class="stroke-icon">
                      <use href="admin/assets/svg/icon-sprite.svg#stroke-charts"></use>
                    </svg>
                    <svg class="fill-icon">
                      <use href="admin/assets/svg/icon-sprite.svg#fill-charts"></use>
                ...
                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav" href="landing-page.html">
                    <svg class="stroke-icon">
                      <use href="admin/assets/svg/icon-sprite.svg#stroke-landing-page"></use>
                    </svg>
                    <svg class="fill-icon">
                      <use href="admin/assets/svg/icon-sprite.svg#fill-landing-page"></use>
                ...
                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav" href="sample-page.html">
                    <svg class="stroke-icon">
                      <use href="admin/assets/svg/icon-sprite.svg#stroke-sample-page"></use>
                    </svg>
                    <svg class="fill-icon">
                      <use href="admin/assets/svg/icon-sprite.svg#fill-sample-page"></use>
                ...
                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav" href="internationalization.html">
                    <svg class="stroke-icon">
                      <use href="admin/assets/svg/icon-sprite.svg#stroke-internationalization"></use>
                    </svg>
                    <svg class="fill-icon">
                      <use href="admin/assets/svg/icon-sprite.svg#fill-internationalization"></use>
                    </svg><span>Internationalization</span></a></li>
                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav" href="admin/starter-kit/index.html" target="_blank">
                    <svg class="stroke-icon">
                      <use href="admin/assets/svg/icon-sprite.svg#stroke-starter-kit"></use>
                    </svg>
                    <svg class="fill-icon">
                      <use href="admin/assets/svg/icon-sprite.svg#fill-starter-kit"></use>
                ...
                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="#">
                    <svg class="stroke-icon">
                      <use href="admin/assets/svg/icon-sprite.svg#stroke-gallery"></use>
                    </svg>
                    <svg class="fill-icon">
                      <use href="admin/assets/svg/icon-sprite.svg#fill-gallery"></use>
                ...
                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="#">
                    <svg class="stroke-icon">
                      <use href="admin/assets/svg/icon-sprite.svg#stroke-blog"></use>
                    </svg>
                    <svg class="fill-icon">
                      <use href="admin/assets/svg/icon-sprite.svg#fill-blog"></use>
                ...
                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="#">
                    <svg class="stroke-icon">
                      <use href="admin/assets/svg/icon-sprite.svg#stroke-job-search"></use>
                    </svg>
                    <svg class="fill-icon">
                      <use href="admin/assets/svg/icon-sprite.svg#fill-job-search"></use>
                ...
                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="#">
                    <svg class="stroke-icon">
                      <use href="admin/assets/svg/icon-sprite.svg#stroke-learning"></use>
                    </svg>
                    <svg class="fill-icon">
                      <use href="admin/assets/svg/icon-sprite.svg#fill-learning"></use>
                ...
                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="#">
                    <svg class="stroke-icon">
                      <use href="admin/assets/svg/icon-sprite.svg#stroke-editors"></use>
                    </svg>
                    <svg class="fill-icon">
                      <use href="admin/assets/svg/icon-sprite.svg#fill-editors"></use>
                ...
                <li class="sidebar-list"> <i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav" href="knowledgebase.html">
                    <svg class="stroke-icon">
                      <use href="admin/assets/svg/icon-sprite.svg#stroke-knowledgebase"></use>
                    </svg>
                    <svg class="fill-icon">
                      <use href="admin/assets/svg/icon-sprite.svg#fill-knowledgebase"></use>
                    ...
                    <div class="card"> 
                      ...
                      <div class="card-body pt-0 row important-project">
                        <div class="col-xl-4 col-md-6 box-col-6">
                          <div class="projectlist-card">
                            <div class="projectlist"> 
                              <div class="project-data"><img class="nft-img img-fluid" src="admin/assets/images/dashboard-2/category/1.png" alt="nft">
                            ...
                            <div class="project-comment">
                              <div class="avatar-showcase">  
                                <div class="avatars">  
                                  <div class="customers d-inline-block avatar-group">
                                    <ul>
                                      <li class="d-inline-block"><img class="img-25 rounded-circle" src="admin/assets/images/user/18.png" alt=""></li>
                                      <li class="d-inline-block"><img class="img-25 rounded-circle" src="admin/assets/images/user/15.png" alt=""></li>
                                      <li class="d-inline-block"><img class="img-25 rounded-circle" src="admin/assets/images/user/19.png" alt=""></li>
                                      <li class="d-inline-block"><img class="img-25 rounded-circle" src="admin/assets/images/user/17.png" alt=""></li>
                              ...
                              <div class="project-comment-icon">
                                <div class="project-link"> 
                                  <svg>     
                                    <use href="admin/assets/svg/icon-sprite.svg#messages-2"></use>
                                  </svg><span>18 </span>
                                </div>
                                <div class="project-link"> 
                                  <svg> 
                                    <use href="admin/assets/svg/icon-sprite.svg#paperclip"></use>
                                  </svg><span>2  </span>
                                </div>
                              </div>
                            </div>
                        ...
                        <div class="col-xl-4 col-md-6 box-col-6">
                          <div class="projectlist-card">
                            <div class="projectlist">
                              <div class="project-data"><img class="nft-img img-fluid" src="admin/assets/images/dashboard-2/category/2.png" alt="nft">
                            ...
                            <div class="project-comment"> 
                              <div class="avatar-showcase"> 
                                <div class="avatars"> 
                                  <div class="customers d-inline-block avatar-group">
                                    <ul> 
                                      <li class="d-inline-block"><img class="img-25 rounded-circle" src="admin/assets/images/user/24.png" alt=""></li>
                                      <li class="d-inline-block"><img class="img-25 rounded-circle" src="admin/assets/images/user/21.png" alt=""></li>
                                      <li class="d-inline-block"><img class="img-25 rounded-circle" src="admin/assets/images/user/23.png" alt=""></li>
                                      <li class="d-inline-block"><img class="img-25 rounded-circle" src="admin/assets/images/user/22.png" alt=""></li>
                                      <li class="d-inline-block">
                        ...
                        <div class="col-xl-4 box-col-none marketing-app-card"> 
                          <div class="projectlist-card"> 
                            <div class="projectlist">
                              <div class="project-data"> <img class="nft-img img-fluid" src="admin/assets/images/dashboard-2/category/3.png" alt="nft">
                            ...
                            <div class="project-comment">
                              <div class="avatar-showcase"> 
                                <div class="avatars"> 
                                  <div class="customers d-inline-block avatar-group">
                                    <ul> 
                                      <li class="d-inline-block"><img class="img-25 rounded-circle" src="admin/assets/images/user/25.png" alt=""></li>
                                      <li class="d-inline-block"><img class="img-25 rounded-circle" src="admin/assets/images/user/26.png" alt=""></li>
                                      <li class="d-inline-block"><img class="img-25 rounded-circle" src="admin/assets/images/user/27.png" alt=""></li>
                                      <li class="d-inline-block"> <img class="img-25 rounded-circle" src="admin/assets/images/user/28.png" alt=""></li>
                                      <li class="d-inline-block"> 
                                  ...
                                  <div class="product-sub"> 
                                    <div class="dropdown"> 
                                      <div id="dropdownMenuButtonicon11" data-bs-toggle="dropdown" aria-expanded="false" role="menu">
                                        <svg class="invoice-icon"> 
                                          <use href="admin/assets/svg/icon-sprite.svg#more-horizontal"></use>
                                        </svg>
                                      </div>
                            ...
                            <tbody>
                                ...
                                <td class="client-list">
                                  <div class="user-id">
                                    <div class="avatars me-2">
                                      <div class="avatar"><img class="img-50 rounded-circle" src="admin/assets/images/user/29.png" alt="#">
                                  ...
                                  <div class="user-comment w-100">
                                    ...
                                    <div class="product-sub">
                                      <svg class="invoice-icon">
                                        <use href="admin/assets/svg/icon-sprite.svg#messages-3"></use>
                                      </svg>
                                    </div>
                                  </div>
                                </td>
                              ...
                              <tr> 
                                <td class="client-list">
                                  <div class="user-id">
                                    <div class="avatars me-2">
                                      <div class="avatar"><img class="img-50 rounded-circle" src="admin/assets/images/user/30.png" alt="#">
                                        <div class="status status-dnd bg-warning"></div>
                                      </div>
                                    </div>
                              ...
                              <tr>
                                <td class="client-list">
                                  <div class="user-id">
                                    <div class="avatars me-2">
                                      <div class="avatar"> <img class="img-50 rounded-circle" src="admin/assets/images/user/33.png" alt="#">
                                        <div class="status status-dnd bg-warning"> </div>
                                      </div>
                                    </div>
                              ...
                              <tr>
                                <td class="client-list"> 
                                  <div class="user-id">
                                    <div class="avatars me-2"> 
                                      <div class="avatar"> <img class="img-50 rounded-circle" src="admin/assets/images/user/31.png" alt="#"></div>
                                    </div>
                              ...
                              <tr>
                                <td class="client-list">
                                  <div class="user-id">
                                    <div class="avatars me-2">
                                      <div class="avatar"><img class="img-50 rounded-circle" src="admin/assets/images/user/32.png" alt="#"></div>
                                    </div>
                        ...
                        <div class="activity-log-card"> 
                          <ul> 
                            <li class="activity-log">
                              <div class="d-flex align-items-start gap-2"><img class="activity-log-img rounded-circle img-fluid me-2" src="admin/assets/images/user/26.png" alt="user"/>
                                <div> 
                            ...
                            <li class="activity-log">
                              <div class="d-flex align-items-start gap-2"><img class="activity-log-img rounded-circle img-fluid me-2" src="admin/assets/images/user/34.png" alt="user"/>
                                <div> 
                                  <div class="common-space user-id">
                            ...
                            <li class="activity-log">
                              <div class="d-flex align-items-start gap-2"><img class="activity-log-img rounded-circle img-fluid me-2" src="admin/assets/images/user/35.png" alt="user"/>
                                <div> 
                                  <div class="common-space user-id">
                            ...
                            <li class="activity-log">
                              <div class="d-flex align-items-start gap-2"><img class="activity-log-img rounded-circle img-fluid me-2" src="admin/assets/images/user/44.png" alt="user"/>
                                <div> 
                                  <div class="common-space user-id">
                            ...
                            <li class="activity-log">
                              <div class="d-flex align-items-start gap-2"><img class="activity-log-img rounded-circle img-fluid me-2" src="admin/assets/images/user/38.png" alt="user"/>
                                <div> 
                                  <div class="common-space user-id">
                    ...
                    <div class="card"> 
                      ...
                      <div class="card-body pt-0">
                        <div class="user-message"> 
                          <ul> 
                            <li>
                              <div class="activity-log"><img class="activity-log-img rounded-circle img-fluid me-2" src="admin/assets/images/user/39.png" alt="user"/>
                            ...
                            <li>
                              <div class="activity-log"><img class="activity-log-img rounded-circle img-fluid me-2" src="admin/assets/images/user/40.png" alt="user"/>
                            ...
                            <li>
                              <div class="activity-log"><img class="activity-log-img rounded-circle img-fluid me-2" src="admin/assets/images/user/41.png" alt="user"/>
                                <div class="status bg-warning"></div>
                                <div class="activity-name">
                                  <div>
                            ...
                            <li>
                              <div class="activity-log"><img class="activity-log-img rounded-circle img-fluid me-2" src="admin/assets/images/user/42.png" alt="user"/>
                                <div class="status bg-undefined"></div>
                                <div class="activity-name">
                                  <div>
                            ...
                            <li>
                              <div class="activity-log"><img class="activity-log-img rounded-circle img-fluid me-2" src="admin/assets/images/user/43.png" alt="user"/>
                                <div class="status bg-warning"></div>
                                <div class="activity-name">
                                  <div>
                            ...
                            <li>
                              <div class="activity-log"><img class="activity-log-img rounded-circle img-fluid me-2" src="admin/assets/images/user/44.png" alt="user"/>
                                <div class="status bg-undefined"></div>
                                <div class="activity-name">
                                  <div>
                            ...
                            <li>
                              <div class="activity-log"><img class="activity-log-img rounded-circle img-fluid me-2" src="admin/assets/images/user/45.png" alt="user"/>
                                <div class="status bg-warning"></div>
                                <div class="activity-name">
                                  <div>
                            ...
                            <li>
                              <div class="activity-log"><img class="activity-log-img rounded-circle img-fluid me-2" src="admin/assets/images/user/15.png" alt="user"/>
                                <div class="status bg-warning"></div>
                                <div class="activity-name">
                                  <div>
                            ...
                            <li>
                              <div class="activity-log"><img class="activity-log-img rounded-circle img-fluid me-2" src="admin/assets/images/user/47.png" alt="user"/>
                                <div class="status bg-undefined"></div>
                                <div class="activity-name">
                                  <div>
